...
Sub Init
    ...
    addMenuItem "Insert New Line &After"          , module_name , "CtrlEnter"                  , "Ctrl+Enter"
    addMenuItem "Insert New Line Between"         , module_name , "InsertLineBetween"          , "Shift+Enter"
    addMenuItem "Insert New Line &Before Current" , module_name , "InsertNewLineBeforeCurrent" , "Shift+Ctrl+Enter"

    addMenuItem "Tab &Next"         , module_name , "NextTab" , "Ctrl+PgDn"
    addMenuItem "Tab &Previous Tab" , module_name , "PrivTab" , "Ctrl+PgUp"
    ...
    addMenuItem "&4. Add {} Braces ToSelection"           , module_name , "AddBracesToSelection"     , "Shift+Ctrl+["

    addMenuItem "&4. Add { } Braces ToSelection"           , module_name , "AddBracesSpToSelection"     , "Shift+Ctrl+]"

    addMenuItem "&5. Add ( ) Round Brackets ToSelection"  , module_name , "AddBracsToSpSelection" , "Ctrl+9"
    addMenuItem "&6. Add () Round Brackets ToSelection"   , module_name , "AddBracsToSelection"   , "Shift+Ctrl+9"

    addMenuItem "&7. Add `` Apostrophes To Selection"     , module_name , "AddApostrophesToSelection" , ""
    addMenuItem "&8. Add %% ProcentsToSelection"          , module_name , "AddProcentsToSelection"    , ""
...
Function AddBracesSpTo(ByVal strInput)
    Dim strOutput, blnBinary, numCount, strChr
    strOutput = ""
    blnBinary = False
    For numCount = 1 To Len(strInput)
    ...
    'wat
    strOutput = "{" &  Chr(13) & Chr(10) & Chr(9) & strOutput &  Chr(13) & Chr(10) & "}"

    End If
    AddBracesSpTo = strOutput
End Function

Sub AddBracesSpToSelection()
    Dim strInput
    With newEditor()
        .assignActiveEditor()
        strInput = AddBracesSpTo(.selText())
        .selText(strInput)
    End With
End Sub
